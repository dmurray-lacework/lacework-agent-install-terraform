...
#    1. sudo sh -c "$(curl -sSL https://s3-us-west-2.amazonaws.com/www.lacework.net/download/2.9.13_2019-10-23_master_03b7d71ca3585ddcf0e2a1474a1f7e41a2fada86/install.sh)" 
#    or
#    1. "curl -sSL https://s3-us-west-2.amazonaws.com/www.lacework.net/download/2.9.13_2019-10-23_master_03b7d71ca3585ddcf0e2a1474a1f7e41a2fada86/install.sh > /tmp/install.sh"
...
# Agent version
version=2.9.13
commit_hash=2.9.13_2019-10-23_master_03b7d71ca3585ddcf0e2a1474a1f7e41a2fada86
deb_sha1=f648a003000b362ecf4a7abb57e7971c99527cd1
rpm_sha1=eb7b0c0fe7316d247c0aa4b81f5be216fb275f37
dc_sha1=1a2ae93d9f10894a3cd075a2a8c8790046653d31
...
ARG1=4e6253806eace4ac25b0f26f0c194be6ba6d440d56e1c675cbbac2f2
if [ ! -z "${ARG1}" ]; then
